...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener {
    ...
    public void actionPerformed(ActionEvent a) {
        ...
        if (a.getActionCommand().equals(seperateColors.getActionCommand())) {
            Picture rPic = new Picture((SimplePicture)picture);
            rPic.keepOnlyRed();
            rPic.explore();
            Picture gPic = new Picture((SimplePicture)picture);
            gPic.keepOnlyGreen();
            gPic.explore();
            Picture bPic = new Picture((SimplePicture)picture);
            bPic.keepOnlyBlue();
            bPic.explore();
        }
        ...
        if (a.getActionCommand().equals(hide.getActionCommand())) {
            Picture newPic = new Picture((SimplePicture)picture);
            Picture hidden = FileChooser.showOpenDialog(pictureFrame);
            newPic.encode(hidden);
            newPic.explore();
        }
